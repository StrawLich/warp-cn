    ...
    fn from(status: ServerCardStatus) -> ServerCardOptions {
        match status {
            ...
            ServerCardStatus::Installed => ServerCardOptions {
                ...
                status_line: Some(warp_i18n::t!("settings-mcp-card-status-offline").to_string()),
                background: Background::Filled,
                full_card_clickable: false,
            },
            ServerCardStatus::StartingServer => ServerCardOptions {
                ...
                status_line: Some(warp_i18n::t!("settings-mcp-card-status-starting").to_string()),
                background: Background::Filled,
                full_card_clickable: false,
            },
...
impl ServerCardView {
    ...
    fn render_tools_expandable(
        ...
        if tools.is_empty() {
            return Text::new(
                warp_i18n::t!("settings-mcp-no-tools-available"),
            ...
            if self.render_options.show_view_logs_icon_button {
                actions_row = actions_row.with_child(
                    self.build_icon_button(
                        appearance,
                        Icon::Code1,
                        warp_i18n::t!("settings-mcp-card-tooltip-show-logs").to_string(),
            ...
            if self.render_options.show_log_out_icon_button {
                actions_row = actions_row.with_child(
                    self.build_icon_button(
                        appearance,
                        Icon::LogOut,
                        warp_i18n::t!("settings-mcp-card-tooltip-log-out").to_string(),
            ...
            if self.render_options.show_share_icon_button {
                actions_row = actions_row.with_child(
                    self.build_icon_button(
                        appearance,
                        Icon::Share,
                        warp_i18n::t!("settings-mcp-card-tooltip-share-server").to_string(),
            ...
            if self.render_options.show_edit_config_icon_button {
                actions_row = actions_row.with_child(
                    self.build_icon_button(
                        appearance,
                        Icon::Pencil,
                        warp_i18n::t!("settings-mcp-card-tooltip-edit").to_string(),
    ...
    fn render_update_available_icon(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let update_available_button = self
            .build_icon_button(
                appearance,
                Icon::Refresh,
                warp_i18n::t!("settings-mcp-card-tooltip-update-available").to_string(),
