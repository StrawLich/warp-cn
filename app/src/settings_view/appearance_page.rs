...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    let mut toggle_binding_pairs = vec![
        ToggleSettingActionPair::new(
            &warp_i18n::t!("settings-appearance-cmd-suffix-compact-mode"),
        ...
        ToggleSettingActionPair::new(
            &warp_i18n::t!("settings-appearance-cmd-suffix-sync-with-os"),
            builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &warp_i18n::t!("settings-appearance-cmd-suffix-cursor-blink"),
            builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &warp_i18n::t!("settings-appearance-cmd-suffix-jump-to-bottom"),
            builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &warp_i18n::t!("settings-appearance-cmd-suffix-block-dividers"),
            builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        &warp_i18n::t!("settings-appearance-cmd-suffix-dim-inactive"),
        builder(SettingsAction::AppearancePageToggle(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        warp_i18n::t!("settings-appearance-input-start-top").to_string(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        warp_i18n::t!("settings-appearance-input-pin-top").to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        warp_i18n::t!("settings-appearance-input-pin-bottom").to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        warp_i18n::t!("settings-appearance-toggle-input-mode").to_string(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &warp_i18n::t!("settings-appearance-cmd-suffix-tab-indicators"),
            builder(SettingsAction::AppearancePageToggle(
        ...
        toggle_binding_pairs.push(
            ToggleSettingActionPair::custom(
                SettingActionPairDescriptions::new(
                    &warp_i18n::t!("settings-appearance-show-code-review-tab"),
                    &warp_i18n::t!("settings-appearance-hide-code-review-tab"),
                ),
                builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &warp_i18n::t!("settings-appearance-cmd-suffix-focus-follows-mouse"),
            builder(SettingsAction::AppearancePageToggle(
    ...
    if FeatureFlag::FullScreenZenMode.is_enabled() {
        ...
        app.register_fixed_bindings([
            FixedBinding::empty(
                warp_i18n::t!("settings-appearance-tab-always-show").to_string(),
                builder(SettingsAction::AppearancePageToggle(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                warp_i18n::t!("settings-appearance-tab-hide-fullscreen").to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                warp_i18n::t!("settings-appearance-tab-hover-only").to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
        ...
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                &warp_i18n::t!("settings-appearance-cmd-suffix-zen-mode"),
                builder(SettingsAction::AppearancePageToggle(
    ...
    if FeatureFlag::VerticalTabs.is_enabled() {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            &warp_i18n::t!("settings-appearance-cmd-suffix-vertical-tabs"),
            builder(SettingsAction::AppearancePageToggle(
    ...
    if FeatureFlag::Ligatures.is_enabled() {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            &warp_i18n::t!("settings-appearance-cmd-suffix-ligatures"),
            builder(SettingsAction::AppearancePageToggle(
...
impl AppearanceSettingsPageView {
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        ...
        categories.push(Category::new(
            warp_i18n::t_static!("settings-appearance-fullscreen-apps"),
    ...
    fn render(
        ...
        Align::new(
            appearance
                .ui_builder()
                .link(
                    warp_i18n::t!("settings-appearance-create-custom-theme").to_string(),
    ...
    fn render(
        ...
        Flex::column()
            ...
            .with_child(render_body_item::<AppearancePageAction>(
                warp_i18n::t!("settings-appearance-sync-with-os").into(),
                None,
...
impl SettingsWidget for CustomAppIconWidget {
    ...
    fn render(
        ...
        let dropdown = render_dropdown_item(
            appearance,
            &warp_i18n::t!("settings-appearance-customize-app-icon"),
                ...
                return Flex::column()
                    ...
                    .with_child(
                        appearance
                            .ui_builder()
                            .wrappable_text(
                                warp_i18n::t!("settings-appearance-restart-icon-hint"),
                                true,
                            )
...
impl SettingsWidget for CustomWindowSizeWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-custom-window-size").into(),
            None,
            LocalOnlyIconState::for_setting(
            ...
            return Flex::column()
                .with_child(
                    Container::new(render_body_item_label::<AppearancePageAction>(
                        warp_i18n::t!("settings-appearance-window-opacity").to_owned(),
                        None,
                        None,
                        LocalOnlyIconState::Hidden,
                ...
                .with_child(
                    Container::new(
                        FormattedTextElement::from_str(
                            warp_i18n::t!("settings-appearance-transparency-not-supported"),
...
impl SettingsWidget for WindowBlurTextureWidget {
    ...
    fn render(
        ...
        let mut col = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-use-window-blur").to_string(),
            None,
            LocalOnlyIconState::for_setting(
        ...
        if let Some(window) = app.windows().platform_window(view.window_id) {
            if !window.supports_transparency() && window.graphics_backend() != GraphicsBackend::Gl {
                col.add_child(
                    Container::new(
                        FormattedTextElement::from_str(
                            warp_i18n::t!("settings-appearance-hardware-no-transparent"),
                            appearance.ui_font_family(),
                            appearance.ui_font_size(),
                        )
                        .with_color(appearance.theme().disabled_ui_text_color().into_solid())
...
impl SettingsWidget for ToolsPanelStateScopeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-tools-panel-consistent").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for InputTypeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-input-type").into(),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
...
impl SettingsWidget for InputModeWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            &warp_i18n::t!("settings-appearance-input-position"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DimInactivePanesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-dim-inactive").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for FocusFollowsMouseWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-focus-follows-mouse").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CompactModeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-compact-mode").into(),
            None,
            LocalOnlyIconState::for_setting(
                Spacing::storage_key(),
...
impl SettingsWidget for JumpToBottomOfBlockWidget {
    ...
    fn render(
        ...
        let enabled = block_list_settings
            ...
            .value();
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-show-jump-bottom").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowBlockDividersWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-show-block-dividers").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AIFontWidget {
    ...
    fn render(
        ...
        ai_font.add_child(render_body_item_label::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-agent-font").to_string(),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl TerminalFontWidget {
    fn render_line_height_editor(
        ...
        line_height.add_child(
            appearance
                .ui_builder()
                .label(warp_i18n::t!("settings-appearance-line-height"))
                .with_style(UiComponentStyles {
                    margin: Some(Coords {
                        left: 12.,
                        ..Default::default()
...
impl SettingsWidget for TerminalFontWidget {
    ...
    fn render(
        ...
        terminal_font.add_child(render_body_item_label::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-terminal-font").to_string(),
            None,
            None,
            LocalOnlyIconState::for_setting(
        ...
        font_weight.add_child(
            appearance
                .ui_builder()
                .label(warp_i18n::t!("settings-appearance-font-weight"))
                .with_style(UiComponentStyles {
                    font_size: Some(CONTENT_FONT_SIZE),
                    ..Default::default()
                })
        ...
        font_size.add_child(
            appearance
                .ui_builder()
                .label(warp_i18n::t!("settings-appearance-font-size-px"))
                .with_style(UiComponentStyles {
                    margin: Some(Coords {
                        left: 2.,
                        ..Default::default()
...
impl SettingsWidget for ThinStrokesWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            &warp_i18n::t!("settings-appearance-thin-strokes"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MinimumContrastWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            &warp_i18n::t!("settings-appearance-min-contrast"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for LigaturesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-show-ligatures").into(),
            Some(AdditionalInfo {
...
impl SettingsWidget for CursorTypeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-cursor-type").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for BlinkingCursorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-blinking-cursor").into(),
            None,
            LocalOnlyIconState::for_setting(
                CursorBlinkEnabled::storage_key(),
                CursorBlinkEnabled::sync_to_cloud(),
...
impl SettingsWidget for TabCloseButtonPositionWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            &warp_i18n::t!("settings-appearance-tab-close-button-pos"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for TabIndicatorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-show-tab-indicators").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CodeReviewButtonWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-show-code-review-btn").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for PreserveActiveTabColorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-preserve-tab-color").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for VerticalTabsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-vertical-tab-layout").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for UseLatestUserPromptAsConversationTitleInTabNamesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-prompt-as-tab-title").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for EditToolbarWidget {
    ...
    fn render(
        ...
        let label = render_body_item_label::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-header-toolbar-layout").to_string(),
            None,
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
...
impl SettingsWidget for DirectoryTabColorsWidget {
    ...
    fn render(
        ...
        let header_text = Flex::column()
            ...
            .with_child(
                Text::new(
                    warp_i18n::t!("settings-appearance-directory-tab-colors"),
                    appearance.ui_font_family(),
                    appearance.ui_font_size(),
                )
            ...
            .with_child(
                Text::new(
                    warp_i18n::t!("settings-appearance-tab-colors-description"),
                    appearance.ui_font_family(),
                    appearance.ui_font_size(),
                )
...
impl SettingsWidget for ZenModeWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            &warp_i18n::t!("settings-appearance-show-tab-bar"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AltScreenPaddingWidget {
    ...
    fn render(
        ...
        let theme = appearance.theme();
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            warp_i18n::t!("settings-appearance-custom-alt-screen-padding").into(),
            Some(AdditionalInfo {
            ...
            let editor_row = Flex::row()
                ...
                .with_child(
                    Container::new(
                        Align::new(
                            Text::new(
                                warp_i18n::t!("settings-appearance-uniform-padding"),
                                appearance.ui_font_family(),
                                appearance.ui_font_size(),
                            )
                            .with_color(theme.active_ui_text_color().into())
