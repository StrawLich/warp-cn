...
lazy_static! {
    static ref REWARDS: Vec<Reward> = vec![
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: warp_i18n::t!("settings-referrals-prize-exclusive-theme"),
        },
        Reward {
            ...
            icon_width: 56.,
            icon_height: 56.,
            label: warp_i18n::t!("settings-referrals-prize-keycaps"),
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: warp_i18n::t!("settings-referrals-prize-tshirt"),
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: warp_i18n::t!("settings-referrals-prize-notebook"),
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: warp_i18n::t!("settings-referrals-prize-baseball-cap"),
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: warp_i18n::t!("settings-referrals-prize-hoodie"),
        },
        Reward {
            ...
            icon_width: 48.,
            icon_height: 48.,
            label: warp_i18n::t!("settings-referrals-prize-hydro-flask"),
        },
        Reward {
            ...
            icon_width: 50.,
            icon_height: 50.,
            label: warp_i18n::t!("settings-referrals-prize-backpack"),
        },
    ];
}
...
impl ReferralsPageView {
    pub fn new(referrals_client: Arc<dyn ReferralsClient>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        let page = PageType::new_monolith(
            ...
            Some(warp_i18n::t_static!("settings-referrals-header")),
            true,
        );
        Self {
            page,
...
impl ReferralsWidget {
    ...
    fn render_signup_section(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let sign_up_button = appearance
            ...
            .with_text_label(warp_i18n::t!("settings-referrals-sign-up"))
            .build()
