...
impl SecretRedactionWidget {
    ...
    fn render_tab_bar(
        ...
        let personal_tab = self.render_tab(
            warp_i18n::t!("settings-privacy-tab-personal"),
            personal_count,
        ...
        let enterprise_tab = self.render_tab(
            warp_i18n::t!("settings-privacy-tab-enterprise"),
            enterprise_count,
        ...
        if is_enterprise_tab_active {
            ...
            row.add_child(self.render_info(
                warp_i18n::t!("settings-privacy-enterprise-not-modifiable"),
                appearance,
            ));
        }
    ...
    fn render_enterprise_content(
        ...
        if enterprise_regex_list.is_empty() {
            return ui_builder
                .paragraph(warp_i18n::t!("settings-privacy-no-enterprise-regexes"))
                .with_style(UiComponentStyles {
                    font_color: Some(description_text_color),
                    ..Default::default()
                })
                            ...
                            Container::new(
                                ui_builder
                                    ...
                                    .with_text_and_icon_label(Self::add_button(
                                        warp_i18n::t!("settings-privacy-add-all"),
                                        appearance,
                                    ))
    ...
    fn render(
                ...
                .with_child(
                    Container::new({
                        if is_enterprise_enabled {
                            self.render_info(
                                warp_i18n::t!("settings-privacy-enabled-by-organization"),
                                appearance,
                            )
                        } else {
                            ui_builder
        ...
        if *safe_mode_settings.safe_mode_enabled {
            ...
            let label_with_icon = super::settings_page::render_dropdown_item_label(
                warp_i18n::t!("settings-privacy-secret-display-mode"),
                None,
                ...
                Flex::row()
                    ...
                    .with_child(
                        ui_builder
                            ...
                            .with_text_and_icon_label(Self::add_button(
                                warp_i18n::t!("settings-privacy-add-regex"),
                                appearance,
                            ))
                            .with_style(Self::add_button_style())
                            .build()
    ...
    fn render(
        ...
        let switch = if is_toggleable {
            ...
            switch
                .with_tooltip(TooltipConfig {
                    text: warp_i18n::t!("settings-privacy-managed-by-organization"),
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        warp_i18n::t!("settings-privacy-telemetry-docs-link"),
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                warp_i18n::t!("settings-privacy-crash-reports-title"),
                None,
...
impl SettingsWidget for CloudConversationStorageWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                warp_i18n::t!("settings-privacy-cloud-conversations-title"),
                None,
                LocalOnlyIconState::Hidden,
                toggle_state,
                appearance,
            ...
            .with_child(
                ui_builder
                    .paragraph(if is_checked {
                        warp_i18n::t!("settings-privacy-cloud-conversations-enabled-desc")
                    } else {
                        warp_i18n::t!("settings-privacy-cloud-conversations-disabled-desc")
                    })
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
...
impl SettingsWidget for NetworkLogWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                warp_i18n::t!("settings-privacy-network-log-title"),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(warp_i18n::t!("settings-privacy-network-log-description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
            ...
            .with_child(
                Align::new(
                    ui_builder
                        .link(
                            warp_i18n::t!("settings-privacy-network-log-link"),
                            None,
                            Some(Box::new(|ctx| {
